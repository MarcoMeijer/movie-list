...
export type CreateListMutation = {
  createList: { created_at: string; email: string; id: number; name: string };
};
...
export type GetMovieListQuery = {
  getMovieList: { id: number; created_at: string; name: string; email: string };
...
`;
export const DeleteListDocument = /*#__PURE__*/ gql`
...
export function getSdk(
  ...
  return {
    ...
    DeleteList(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteListMutation>(DeleteListDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "DeleteList",
    ...
    GetMovie(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetMovieQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMovieQuery>(GetMovieDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetMovie",
    ...
    GetMovieList(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMovieListQuery>(GetMovieListDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetMovieList",
